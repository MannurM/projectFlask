...
# Спарсить данные текущий плюс 7 дней
# Спарсить данные за прошлый период,  создать словарь с данными
# Подготовить шаблон открытки
# Сделать класс для работы с БД запись и чтение
